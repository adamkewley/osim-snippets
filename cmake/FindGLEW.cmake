...
set(GLEW_ROOT "NOTFOUND" CACHE PATH "Path to GLEW root, as downloaded from site")
...
find_path(GLEW_INCLUDE_DIR REQUIRED GL/glew.h HINTS ${GLEW_ROOT})

set(GLEW_INCLUDE_DIRS "${GLEW_INCLUDE_DIR}" CACHE PATH "Path to include dir for GLEW. Usually, it's a dir containing the glew subdir")
...
if(NOT GLEW_FOUND)
  message(FATAL " FindGLEW: could not find GLEW library.")
endif()
